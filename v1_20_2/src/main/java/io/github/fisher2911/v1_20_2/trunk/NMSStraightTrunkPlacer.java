...
package io.github.fisher2911.v1_20_2.trunk;
...
public class NMSStraightTrunkPlacer extends TrunkPlacer {
    ...
    public NMSStraightTrunkPlacer(int baseHeight, int firstRandomHeight, int secondRandomHeight) {
